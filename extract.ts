...
import { extractYouTube, extractYouTubeFrame, extractYouTubeFrames, getYouTubeStreamInfo, isYouTubeEnabled, isYouTubeURL } from "./youtube-extract.js";
...
function buildFrameResult(url: string, label: string, requestedCount: number, frames: VideoFrame[], error: string | null, duration?: number): ExtractedContent {
	if (frames.length === 0) {
